...
`) as { fileName: string; sourceCode: string; summary: string }[];
  ...
  //       prompt: `You are a ai code assistant who answers questions about the codebase. Your target audience is a technical intern who is new to the codebase.
  ...
  // Answer in markdown syntax, with code snippets if needed. Be as detailed as possible when answering, markdown only.
  // `,
  //     });
